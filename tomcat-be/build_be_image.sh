...
echo -e "\nRetrieving SUPERSEDE Model Repository Manager ...\n"
FILE_IN=/opt/jenkins/apps/jenkins/jenkins_home/jobs/DynamicAdaptation/workspace/Enactment/components/adapter/model/eu.supersede.dynadapt.modelrepository.manager.service/build/libs/modelrepositorymanager-0.1.0.war
FILE_OUT=./webapps/modelrepositorymanager.war
sshpass -p "$PASSWORD" scp $USER@$HOST:"\"$FILE_IN\"" $FILE_OUT
