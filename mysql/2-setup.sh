...
mysql -u supersede -p'supersede' feedback_orchestrator < /supersede/migrations/repository/0010_change_table_collations_20161111.sql
mysql -u supersede -p'supersede' feedback_orchestrator < /supersede/migrations/repository/0011_change_timestamp_precision_20161123.sql
